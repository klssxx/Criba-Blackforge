...
**Última actualización:** 2026-09-03 07:35:20+02:00 — P07-T02 VERIFIED; P07-T03 NOT_STARTED
...
P05 and P06 are closed. P06-T01 through P06-T09 and P07-T01 through P07-T02 are verified. P07-T03 (burst detection) is **NOT_STARTED**. No code is currently uncommitted; the next task is recorded in `STATE.json`.
...
`594aa56` — P07-T02 discrete topic velocity and acceleration, with 23 targeted signal/storage/contract tests and full CRIBA regression at 779 passed.
...
P07-T03: burst detection. BF-P00-T06 remains deferred until tracked BLACKFORGE goldens are validated in an isolated copy.

## WHAT MODEL/REASONING SHOULD EXECUTE IT?
GPT-5.6 Terra high, per blueprint. Required verification: implement burst detection over the observation dynamics, add focused tests, run strict mypy for touched modules, `git diff --check`, and the full regression before advancing the checkpoint.
