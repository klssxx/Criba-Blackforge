...
def _idea(method: Mapping[str, Any], current: Mapping[str, Any], query: str) -> dict[str, Any]:
    ...
    mechanism={"diagnostico":"exponer supuestos medibles","inversion":"buscar el fallo minimo","sustraccion":"eliminar una dependencia","restricciones":"limitar complejidad","actores_roles":"separar facultades","incentivos":"alinear costes y recompensas","morfologia":"combinar dimensiones independientes","recombinacion":"integrar dos mecanismos","analogias":"trasplantar una regla causal","arquitectura":"compartimentar autoridad","gobernanza":"hacer reglas auditables","diseno_adversarial":"simular abuso seguro","escenarios":"probar frontera","prototipado":"validar en sombra","verificacion":"comprobar una relacion reproducible","decision_riesgo":"limitar dano y habilitar rollback","ruptura_marco":"romper paradigma existente","salto_espacio":"saltar a meta-nivel","general":"conexion no obvia","lente_avanzado":"perspectiva temporal distinta","perspectiva":"cuestionar la fuente","diseno_investigacion":"datos empiricos del usuario","seguridad":"amenaza como motor","estrategia":"pensar en sistemico","innovacion":"experimento rapido","etica":"valor como restriccion","facilitacion":"participacion masiva","ciencia_realidad":"method empirico","filosofia":"primeros principios","psicologia":"inconsciente como variable","creacion_diseno":"materialidad como prototipo","historia_culturas":"lecciones historicas","investigacion":"metodo cientifico","juegos_innovacion":"juego como laboratorio","diseno":"diseno centrado en humano","mejora":"ciclo continuo","proceso":"flujo visualizado","negocio":"valor economico como palanca","sostenibilidad":"ciclo cerrado"}[family]
