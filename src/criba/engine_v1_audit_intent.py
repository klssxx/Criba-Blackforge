...
def _extract(query:str, context:dict) -> dict:
...
def _idea(method:dict, current:dict, query:str)->dict:
...
def activate(query:str,current:str="auto",mode:str="balanced",supporting_methods:int=4,context:dict|None=None,safety_level:str="strict",manual_methods:list[str]|None=None) -> dict:
