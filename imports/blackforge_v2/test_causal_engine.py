...
def model():
    return {
        ...
        "variables": [
            ...
            {
                "id": "CV-002",
                "axis": "evidence_required",
                "baseline_value": "human_approval",
        ...
        "outcomes": [
            {
                "id": "OUT-001",
                "allowed_directions": ["increase", "decrease", "maintain"],
            }
        ],
    }
...
def test_weight_profile_must_be_versioned_and_sum_to_one():
    with pytest.raises(ValueError):
        CausalWeightProfile(
            ...
            domain="test",
            weights={
                "primary_variable": 0.5,
                "primary_transition": 0.5,
                "intervention_set": 0.5,
                "outcome_set": 0.0,
